...
<template>
    <div class="flex gap-4 overflow-x-auto">
        <Breadcrumb :class="`text-nowrap p-4 ${isMobileScreenSize ? 'h-[44px] pt-4 pb-0 overflow-y-clip' : ''}`" :home="{ icon: 'ti ti-home', route: '/', label: $t('breadcrumbs.home', 'Home') }" :model="breadcrumbs" aria-label="Breadcrumbs">
