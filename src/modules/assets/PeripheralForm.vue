<script setup lang="ts">
    ...
    import { Button, InputNumber, InputText, SelectButton, Textarea, useToast } from "@cjdevstudios/bumblevue";
    ...
    const mainItem: ReturnType<typeof useAsset<'Peripheral'>> = inject('mainItem');
...
<template>
    <section class="h-full overflow-y-auto">
        <AdvancedForm schemaName="Peripheral" :initialValues="initialValues" class="flex flex-col gap-4 w-full sm-w-56 px-4" @submit="onFormSubmit">
            <FormFields>
                ...
                <ValidatedFormField name="brand" label="Brand" :as="InputText" :fieldProps="{type: 'text'}"></ValidatedFormField>
